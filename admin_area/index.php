    ...
    <div class="container-fluid p-0">
                        ...
                        <?php 
                            if(!isset($_SESSION['adminname'])) {
                                echo "<li class='nav-item'>
                                        <a class='nav-link' href='admin_login.php'>Welcome admin</a>
                                    </li>";
                            }else {
                                echo "<li class='nav-item'>
                                        <a class='nav-link' href='index.php'>Welcome ".$_SESSION['adminname'] ."</a>
                                    </li>";
                            }
                            if(!isset($_SESSION['adminname'])) {
                                echo "<li class='nav-item'>
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                <div class="p-3">
                    <a href="#"><img src="../images/imageadmin.jpg" alt="" class="admin_image"></a>
                ...
                <div class="button text-center">
                    ...
                    <button>
                        <a href="index.php?view_products" class="nav-link text-light bg-info my-1">Views Products</a>
                    </button>
                    <button>
                        <a href="index.php?insert_category" class="nav-link text-light bg-info my-1">Insert Categories</a>
                    </button>
                    <button>
                        <a href="index.php?view_categories" class="nav-link text-light bg-info my-1">Views Categories</a>
                    </button>
                    <button>
                        <a href="index.php?insert_brand" class="nav-link text-light bg-info my-1">Insert Brands</a>
                    </button>
                    <button>
                        <a href="index.php?view_brands" class="nav-link text-light bg-info my-1">Views Brands</a>
                    </button>
                    <button>
